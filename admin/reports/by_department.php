...
// Per-department totals + status breakdown + avg resolution time
$sql = "SELECT 
            d.name AS dept_name,
            COUNT(c.id) AS total,
...
$labels = json_encode(array_column($rows, 'dept_name'));
...
<div class="wrap">
    ...
    <a href="by_department.php" class="active"> 
        By Department 
    </a> 
 
    <a href="by_category.php"> 
        By Category 
    </a> 
 
    <a href="monthly_trends.php"> 
        Monthly Trends 
    </a> 
 
    <a href="frequent_problems.php"> 
        Frequent Problems 
    </a> 
</div>
    <div class="main">
        ...
        <h1>System Reports — Complaints by Department</h1>
        ...
        <div class="card">
            <table>
                <tr>
                    <th>Department</th><th>Total</th><th>Pending</th>
<th>In Progress</th><th>Resolved</th><th>Avg Resolution (hrs)</th>                </tr>
...
<td><?= $r['avg_hours'] !== null ? $r['avg_hours'] : '-' ?></td>                </tr>
                <?php endforeach; ?>
            </table>
            <div style="margin-top:20px;">
<a href="export_department_pdf.php"
   target="_blank"
   class="btn btn-pdf"
